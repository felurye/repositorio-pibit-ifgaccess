...
void loop(){
  ...
  if(conteudo.substring(1) == "86 45 75 1F"){ //TESTA SE O CARTÃO LIDO POSSUI CÓDIGO IGUAL AO DA SEQUÊNCIA "83 8E 58 02" / "83 8E 58 02" DEVE SER ALTERADO PARA O UID DO SEU CARTÃO PLÁSTICO
  ...
  if(conteudo.substring(1) == "7D 42 5B D3"){ //TESTA SE O CARTÃO LIDO POSSUI CÓDIGO IGUAL AO DA SEQUÊNCIA "A3 37 1D 00" / "A3 37 1D 00" DEVE SER ALTERADO PARA O UID DO SEU CHAVEIRO
